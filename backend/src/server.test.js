...
describe('GET /api/incidents', function () {
	// Just in case, if the database is empty, we fill it with some data (at the moment we have a data-filled database)
	...
	test('should require authorization', function (done) {
		request
			.get('/movies')
			.expect(401)
	...
	test('should respond with JSON array', function (done) {
